...
namespace Ryujinx.HLE.HOS.Services.Ns
{
    ...
    class IAddOnContentManager : IpcService
    {
        ...
        public static ResultCode CountAddOnContent(ServiceCtx context)
        {
            ...
            byte runtimeAddOnContentInstall = context.Device.System.ControlData.Value.RuntimeAddOnContentInstall;
        ...
        {
            ulong aocBaseId = context.Device.System.ControlData.Value.AddOnContentBaseId;

            if (aocBaseId == 0)
            {
                aocBaseId = context.Device.System.TitleId + 0x1000;
            }
